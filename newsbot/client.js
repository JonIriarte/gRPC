...
const newsItems=["The NASDAQ gained 1.5% yesterday", "Tomorrow's forecast: Mostly cloudy", "Olympics starts today", "We just loved Car Bomb performance!", "Single winner in the lottery today"]
...
var intervalId = setInterval(function () {
  ...
  if (itemsCount == 10) {
    ...
    call.write({news_item: "That's all for today!"});
    call.end();
  }
}, 1000);